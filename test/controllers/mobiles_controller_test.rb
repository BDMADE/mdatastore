...
class MobilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mobile" do
    assert_difference('Mobile.count') do
      post mobiles_url, params: { mobile: { category_id: @mobile.category_id, name: @mobile.name, number: @mobile.number } }
    end
  ...
  test "should update mobile" do
    patch mobile_url(@mobile), params: { mobile: { category_id: @mobile.category_id, name: @mobile.name, number: @mobile.number } }
